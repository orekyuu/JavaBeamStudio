...
import net.orekyuu.javatter.api.twitter.control.TwitterControlException;
import net.orekyuu.javatter.api.twitter.control.TwitterStatusCode;
...
//                stream.onUserListCreation(listOwner, list);
    ...
    public void favorite(Tweet tweet) {
        try {
            ...
            throw new TwitterControlException(TwitterStatusCode.fromStatusCode(e.getStatusCode()), e.getErrorMessage());
        }
    }
