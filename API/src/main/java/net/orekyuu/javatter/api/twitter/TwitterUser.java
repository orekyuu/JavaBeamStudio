...
import net.orekyuu.javatter.api.twitter.control.FavoriteControl;
import net.orekyuu.javatter.api.twitter.control.RetweetControl;
import net.orekyuu.javatter.api.twitter.control.TweetControl;
